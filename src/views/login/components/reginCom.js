      ...
      >
        <View style={styles.loginBox}>
          ...
          <View style={styles.loginCon}>
            ...
            <Button onPress={()=>{this.reginHandle()}} buttonStyle={{marginLeft:10,marginRight:10}} title="立即注册"></Button>
            <View style={{flexDirection:"row",padding:10}}>
              <Text style={{...styles.tStyle,textAlign:"left"}} onPress={this.vHandle}>注册说明</Text>
